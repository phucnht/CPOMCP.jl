...
function CPOMCPDPWTree(pomdp::CPOMDP, b, sz::Int=1000)
  ...
  return CPOMCPDPWTree{S,A,O}(sizehint!(Int[0], sz),
    ...
    sizehint!([Array{S}(undef, 1)], sz), sizehint!(Int[], sz),
    sizehint!(Float64[], sz),
    ...
    Set{Tuple{Int,Int}}(), n_costs(pomdp),
